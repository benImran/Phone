 ...
 */
class Version20170926134518 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE model ADD name VARCHAR(100) NOT NULL, CHANGE name_id brand_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE model DROP name, CHANGE brand_id name_id INT DEFAULT NULL');
